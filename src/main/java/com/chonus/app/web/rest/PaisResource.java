...
/**
 * REST controller for managing {@link com.chonus.app.domain.Pais}.
 */
@RestController
@RequestMapping("/api")
public class PaisResource {
    ...
    private static final String ENTITY_NAME = "projetoBaseChronusPais";
    ...
    public ResponseEntity<PaisDTO> updatePais(@RequestBody PaisDTO paisDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paisDTO.getId()))
            .body(result);
    }
