...
/**
 * REST controller for managing {@link com.chonus.app.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
public class EnderecoResource {
    ...
    private static final String ENTITY_NAME = "projetoBaseChronusEndereco";
    ...
    public ResponseEntity<EnderecoDTO> updateEndereco(@Valid @RequestBody EnderecoDTO enderecoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, enderecoDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<EnderecoDTO> getEndereco(@PathVariable String id) {
