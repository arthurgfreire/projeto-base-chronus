...
/**
 * REST controller for managing {@link com.chonus.app.domain.Cidade}.
 */
@RestController
@RequestMapping("/api")
public class CidadeResource {
    ...
    private static final String ENTITY_NAME = "projetoBaseChronusCidade";
    ...
    public ResponseEntity<CidadeDTO> updateCidade(@Valid @RequestBody CidadeDTO cidadeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, cidadeDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CidadeDTO> getCidade(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteCidade(@PathVariable String id) {
