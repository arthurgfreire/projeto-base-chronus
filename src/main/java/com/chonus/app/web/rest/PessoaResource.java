...
/**
 * REST controller for managing {@link com.chonus.app.domain.Pessoa}.
 */
@RestController
@RequestMapping("/api")
public class PessoaResource {
    ...
    private static final String ENTITY_NAME = "projetoBaseChronusPessoa";
    ...
    public ResponseEntity<PessoaDTO> updatePessoa(@Valid @RequestBody PessoaDTO pessoaDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, pessoaDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PessoaDTO> getPessoa(@PathVariable String id) {
